...
```shell
.\cimipkg.exe C:\Users\adoe\DevOps\Cimian\packages\StartSet
```

#### Installing with Chocolatey

```shell
choco install StartSet --source="C:\Users\adoe\DevOps\Cimian\packages\StartSet\build"
```
...
```
2024/10/14 13:00:00 main.go:350: Using project directory: C:\Users\adoe\DevOps\Cimian\packages\StartSet
